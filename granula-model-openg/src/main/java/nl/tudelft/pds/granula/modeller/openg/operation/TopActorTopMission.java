...
package nl.tudelft.pds.granula.modeller.openg.operation;
...
public class TopActorTopMission extends AbstractOperationModel {
    ...
    public TopActorTopMission() {
        super(OpenGType.TopActor, OpenGType.TopMission);
    }
...
//                    add("ArchivingTime");
    ...
    protected class SummaryDerivation extends BasicSummaryDerivation {
        ...
        public boolean execute() {
                Operation operation = (Operation) entity;
                String summary = String.format("The [%s] operation is the top-level operation of each OpenG job. ", operation.getName());
