...
/**
 * Collection of OpenG configuration options.
 *
 * @author Yong Guo
 * @author Tim Hegeman
 */
public final class JobConfiguration {
	...
	/**
	 * Creates a new JobConfiguration object to capture all OpenG parameters that are not specific to any algorithm.
	 *
	 * @param executableDirectory the directory containing OpenG executables
	 */
	...
	/**
	 * @return the directory containing OpenG executables
	 */
